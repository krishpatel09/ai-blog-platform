        ...
        <div className="flex items-center gap-6">
          ...
          <DropdownMenu modal={false}>
            <DropdownMenuTrigger asChild>
              <div className="w-8 h-8 rounded-full bg-pink-700 text-white flex items-center justify-center text-sm font-medium cursor-pointer hover:shadow-lg transition-shadow">
                K
              </div>
            </DropdownMenuTrigger>
            <DropdownMenuContent
