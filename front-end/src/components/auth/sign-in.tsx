        ...
        <div className="space-y-5">
          <div className="space-y-2">
            ...
            <Input
              ...
              className={`h-12 rounded-lg border-gray-300 px-4 text-white focus:ring-black dark:bg-gray-900 dark:border-gray-700 dark:text-white [&:-webkit-autofill]:text-white! [&:-webkit-autofill]:[-webkit-text-fill-color:white] [&:-webkit-autofill]:transition-[background-color] [&:-webkit-autofill]:duration-[500000s] ${
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              <Input
                ...
                className={`h-12 rounded-lg border-gray-300 px-4 pr-10 text-white focus:ring-black dark:bg-gray-900 dark:border-gray-700 dark:text-white [&:-webkit-autofill]:text-white! [&:-webkit-autofill]:[-webkit-text-fill-color:white] [&:-webkit-autofill]:transition-[background-color] [&:-webkit-autofill]:duration-[500000s] ${
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="text-sm">
            <Link
              ...
              className="font-medium text-gray-500 hover:text-gray-800 dark:text-gray-400"
            >
              Forgot Password?
            </Link>
          </div>
